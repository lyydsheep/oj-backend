...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.UserAccount = field.NewString(tableName, "user_account")
	...
	_user.UserProfile = field.NewString(tableName, "user_profile")
...
func (u *user) updateTableName(table string) *user {
	...
	u.UserAccount = field.NewString(table, "user_account")
	...
	u.UserProfile = field.NewString(table, "user_profile")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["user_profile"] = u.UserProfile
